...
public class TinyDB {
    ...
    public void putListResultPoint(String key, List<ResultPoint> resultPoints) {
        checkForNullKey(key);
        Gson gson = new Gson();
        String json = gson.toJson(resultPoints);
        preferences.edit().putString(key, json).apply();
    }

    public List<ResultPoint> getListResultPoint(String key) {
        checkForNullKey(key);
        Gson gson = new Gson();
        String json = preferences.getString(key, "");
        ResultPoint[] resultPoints = gson.fromJson(json, ResultPoint[].class);
        return resultPoints != null ? Arrays.asList(resultPoints) : new ArrayList<>();
    }
